...
then
	...
	iio_readdev -n $master_IP -b $buffers -s $samples -T 10000 axi-adrv9009-rx-hpc voltage0_i voltage0_q voltage2_i voltage2_q voltage4_i voltage4_q voltage6_i voltage6_q > samples_master.dat &
	pid_master=$!

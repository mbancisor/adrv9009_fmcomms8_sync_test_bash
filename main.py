...
chan1 = (data1[2] + data1[3])

chan2 = (data1[4] + data1[5])
chan3 = (data1[6] + data1[7])
...
fields=[time_start,rx1rx2,rx1rx3,rx3rx4]
...
print("###########")
print("Same  SOM       ", rx1rx2)
print("Across          ", rx1rx3)
print("Same F8         ", rx3rx4)
print("###########")
...
if False:
	...
	plt.plot(data1[2][:100], label='3')
	plt.plot(data1[4][:100], label='5')
	plt.plot(data1[6][:100], label='7')
